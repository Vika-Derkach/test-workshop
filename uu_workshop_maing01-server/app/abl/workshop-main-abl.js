...
const Errors = require("../api/errors/workshop-main-error.js");
...
const logger = LoggerFactory.get("WorkshopMainAbl");

class WorkshopMainAbl {
  constructor() {
...
module.exports = new WorkshopMainAbl();
