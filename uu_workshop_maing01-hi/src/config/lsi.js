const Lsi = {
  appName: {
    cs: "Aplikace uuWorkshop",
    en: "Application uuWorkshop",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuWorkshop",
      en: "About application uuWorkshop",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuWorkshop.",
      en: "You can buy your own uuWorkshop.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuWorkshop.",
      en: "You don't have rights to initialize this uuWorkshop.",
    },
  },
